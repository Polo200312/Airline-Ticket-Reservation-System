<template>
  <div class="base_form">
    <div class="base_header">
      ...
      <div class="base_title">学生成绩信息</div>
    </div>
  ...
  <dialog id="favDialog" onclose="close()" style="
    ...
    <div class="dialog-div" style="margin-top: 5px height:1200px">
      <table class="dialog-content">
        <tr>
          <td colspan="1" style="text-align: right">学生学号</td>
          <td colspan="1">{{ editedItem.studentNum + "-" + editedItem.studentName }}</td>
        </tr>
        <tr>
          <td colspan="1" style="text-align: right">课程信息</td>
          <td colspan="1">{{ editedItem.courseNum + "-" + editedItem.courseName }}</td>
        </tr>
        <tr>
...
import {
  ...
  getTeacherCourseItemOptionList,
  scoreSave,
  scoreDelete,
...
export default defineComponent({
  ...
  methods: {
    ...
    async initialize() {
      this.scoreList = await getTeacherScoreList(this.studentId, this.courseId);
      this.courseList = await getTeacherCourseItemOptionList();
