  ...
  <div class="edit-client">
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span
          ><el-icon><Checked /></el-icon>编辑航空公司信息</span
        >
      </div>
      <el-form ref="flightForm" label-width="120px" class="new-client-form">
        <el-form-item label="用户名">
          <el-input v-model="name" placeholder="请输入航空公司名"></el-input>
        </el-form-item>
...
export default defineComponent({
  ...
  methods: {
    async query() {
      ...
      this.name = this.$route.query.airlineCompanyName as string;
    ...
    async submitForm() {
      ...
      if (this.address == "" || this.address == undefined) {
        message(this, "地址为空,请填写！");
        return;
      }
      if (this.introduction == "" || this.introduction == undefined) {
        message(this, "简介为空,请填写！");
        return;
      }
      let res= await changeAirlineCompanySave({
