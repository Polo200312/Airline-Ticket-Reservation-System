      ...
      <el-col :span="17" class="custom-info">
        <el-card class="box-card" v-if="!editMode">
          <div slot="header" class="clearfix1">
            ...
            <div>
              ...
              <p>
                <strong
                  ><el-icon><user /></el-icon>航空公司名称：</strong
                >{{ info.name }}
              </p>
              <p>
                <strong
              ...
              <p>
                <strong
                  ><el-icon><location /></el-icon>地址：</strong
                >{{ info.address }}
              </p>
              <p>
                <strong
                  ><el-icon><flag /></el-icon>公司简介：</strong
                >{{ info.introduction }}
              </p>
            </div>
          </div>
        ...
        <el-card class="box-card" v-else>
          ...
          <el-form ref="form" label-width="100px">
            ...
            <el-form-item>
              <el-button type="primary" @click="changeAirlineCompanyData()"
                >保存</el-button
              >
...
import { ElMenu, ElSubMenu, ElMenuItemGroup, ElMenuItem, ElDialog, ElButton } from 'element-plus';
import {Setting, Postcard, ChatDotSquare, Stopwatch, Ticket, Upload, Edit, UploadFilled, Mouse, Finished, RefreshLeft, Bell, Folder, UserFilled, User, Wallet, Sort, Message, Phone, BellFilled, Opportunity, CreditCard, Location, Flag,} from '@element-plus/icons-vue'
...
export default defineComponent({
  ...
  methods: {
    ...
    async changeAirlineCompanyData() {
      let res = await changeAirlineCompanyData({
        airlineCompanyId: this.info.airlineCompanyId,
        name: this.name,
        phone: this.phone,
        email: this.email,
